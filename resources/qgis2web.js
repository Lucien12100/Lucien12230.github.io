...
map.getView().fit([342983.386114, 5482674.209728, 343969.390816, 5483428.242249], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Projet Voie-Verte Millau-Aguessac / Parcelles traversées</h2>';
        return titleElement;
    })(),
